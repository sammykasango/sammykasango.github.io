...
### 🙋‍♂️ Who I Am
I'm a **System Software & Network Engineer** based in **Nairobi, Kenya 🇰🇪**, passionate about building scalable, high-performance applications from backend systems to full-stack web platforms.
...
|:--------|:------------|:------|
| 🧠 **AI Health Risk Predictor** | ML model that analyzes patient data to flag early health risks. Deployed with Flask API + Docker. | Python, TensorFlow, Flask, MySQL, Docker |
| 🛒 **E-Commerce Platform** | Full-stack store with M-Pesa Daraja API integration for mobile payments. | React.js, Node.js, MongoDB, M-Pesa API |
| 🐛 **Bug Detection System** | C++ static analysis tool detecting 5 common code smells. Reduced bug tickets by 25%. | C++, OOP |
| 🏫 **School Management System** | Multi-module ERP with RBAC, deployed live in Nakuru County serving 300+ users. | PHP, Laravel, MySQL |
...
👨‍🏫 **Teaching Assistant** — Advanced Software Engineering *(2026–Present)*

🧑‍💻 **Intern** — [Tunga.io](https://tunga.io) Remote *(Jul–Dec 2022)*

🌐 **Lead** — Murang'a Tech Club *(2025)*
